...
function formatCall(procedureName, parameters, compact = false) {
  const separator = compact ? ", " : ",";
  const openingSpace = compact ? "" : " ";
  return `CALL MWCONFIG.${procedureName}(${openingSpace}${parameters.join(separator)});`;
}
